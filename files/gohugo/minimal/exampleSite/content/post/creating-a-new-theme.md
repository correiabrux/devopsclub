...
Web Server is available at http://localhost:
...
Notice that the posts now have content. You can go to localhost:/post/first to verify.
...
<html>
<body>
    <h1><a href="http://localhost:/post/theme/">creating a new theme</a></h1>
    <h1><a href="http://localhost:/about-time/">about</a></h1>
    <h1><a href="http://localhost:/post/second-post/">second</a></h1>
    <h1><a href="http://localhost:/post/first-post/">first</a></h1>
<script>document.write('<script src="http://'
        + (location.host || 'localhost').split(':')[0]
		+ ':/livereload.js?mindelay=10"></'
        + 'script>')</script></body>
